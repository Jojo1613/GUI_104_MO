...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public NewJFrame() {
       initComponents();
       jPanel0.setVisible(true);//rendo visibili solo i due pannelli che voglio
    ...
    */
    ...
    private void ClosePorta(){//Funzione per resettare il valore della porta
        porta=null;           //per disabilitare la com
        speed=0;
    }
    ...
    */
     public  void TxPacchetto(byte len, byte info[]){
        ...
        try{//costruisco il mio dato da trasmettere a partire dallo startTx fino ad endTx
            ...
            if (Test2==1){//Se sono in TEST2 allora fammi il check sbagliato
                uart1.writeByte((byte)(check_L-1));
                Test2=0;//abbasso il flag
            }
            else{
                uart1.writeByte((byte)check_L);//altrimenti fallo giusto
            }
